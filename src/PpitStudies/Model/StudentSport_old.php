...
/*    public $parents_marital_status;
    ...
    public $contact_1_n_first;
    public $contact_1_n_last;
    public $contact_1_email;
    public $contact_1_tel_cell;
    public $contact_1_tel_org;
    public $contact_1_adr_street;
    public $contact_1_adr_zip;
    public $contact_1_adr_city;
    public $contact_1_adr_country;
    public $contact_1_occupation;
    public $contact_2;
    public $contact_2_status;
    public $contact_2_n_first;
    public $contact_2_n_last;
    public $contact_2_email;
    public $contact_2_tel_cell;
    public $contact_2_tel_org;
    public $contact_2_adr_street;
    public $contact_2_adr_zip;
    public $contact_2_adr_city;
    public $contact_2_adr_country;
    public $contact_2_occupation;
    public $bill_contact;
