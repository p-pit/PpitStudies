...
/*	
	...
	'core_account/p-pit-studies' => array(
		'properties' => array(
			...
			'invoice_account_id', 'groups', 'opening_date', 'closing_date', 'callback_date', 'first_activation_date', 'date_1', 'date_2', 'date_3', 'date_4', 'date_5', 'next_meeting_date', 'next_meeting_confirmed', 'priority', 'origine', 'has_replied', 'contact_history',
...
/*		'tiny_2' => 'O',
	...
	'commitmentTerm/report/p-pit-studies' => array(
		...
		'account_property_15' => ['position' => 'D'],
		'account_property_4' => ['position' => 'E'],
		'account_property_19' => ['position' => 'F'],
		'account_property_6' => ['position' => 'G'],
		'account_property_1' => ['position' => 'H'],
		'invoice_account_id' => ['position' => 'I'],
		'email' => ['position' => 'J'],
		'account_groups' => ['position' => 'K'],
		'commitment_tax_inclusive' => ['position' => 'L'],
		'collected' => ['position' => 'M', 'type' => 'sum', 'labels' => ['default' => 'Elève - Encaissé'], 'indicator' => 'amount', 'filter' => ['status' => 'collected', 'invoice_account_id' => false]],
		'settled' => ['position' => 'N', 'type' => 'sum', 'labels' => ['default' => 'Elève - Réglé'], 'indicator' => 'amount', 'filter' => ['status' => 'settled', 'invoice_account_id' => false]],
		'invoiced' => ['position' => 'O', 'type' => 'sum', 'labels' => ['default' => 'Elève - Facturé'], 'indicator' => 'amount', 'filter' => ['status' => 'invoiced', 'invoice_account_id' => false]],
		'to_invoice' => ['position' => 'P', 'type' => 'sum', 'labels' => ['default' => 'Elève - A facturer'], 'indicator' => 'amount', 'filter' => ['status' => 'to_invoice', 'invoice_account_id' => false]],
		'expected' => ['position' => 'Q', 'type' => 'sum', 'labels' => ['default' => 'Elève - Attendu'], 'indicator' => 'amount', 'filter' => ['status' => 'expected', 'invoice_account_id' => false]],
		'rejected' => ['position' => 'R', 'type' => 'sum', 'labels' => ['default' => 'Elève - Rejeté'], 'indicator' => 'amount', 'filter' => ['status' => 'rejected', 'invoice_account_id' => false]],
		'proceedings' => ['position' => 'S', 'type' => 'sum', 'labels' => ['default' => 'Elève - Procédure'], 'indicator' => 'amount', 'filter' => ['status' => 'proceedings', 'invoice_account_id' => false]],
		'invoice_account_collected' => ['position' => 'T', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Encaissé'], 'indicator' => 'amount', 'filter' => ['status' => 'collected', 'invoice_account_id' => true]],
		'invoice_account_settled' => ['position' => 'U', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Réglé'], 'indicator' => 'amount', 'filter' => ['status' => 'settled', 'invoice_account_id' => true]],
		'invoice_account_invoiced' => ['position' => 'V', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Facturé'], 'indicator' => 'amount', 'filter' => ['status' => 'invoiced', 'invoice_account_id' => true]],
		'invoice_account_to_invoice' => ['position' => 'W', 'type' => 'sum', 'labels' => ['default' => 'Financeur - A facturer'], 'indicator' => 'amount', 'filter' => ['status' => 'to_invoice', 'invoice_account_id' => true]],
		'invoice_account_expected' => ['position' => 'X', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Attendu'], 'indicator' => 'amount', 'filter' => ['status' => 'expected', 'invoice_account_id' => true]],
		'invoice_account_rejected' => ['position' => 'Y', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Rejeté'], 'indicator' => 'amount', 'filter' => ['status' => 'rejected', 'invoice_account_id' => true]],
		'invoice_account_proceedings' => ['position' => 'Z', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Procédure'], 'indicator' => 'amount', 'filter' => ['status' => 'proceedings', 'invoice_account_id' => true]],
		'total_collected' => ['position' => 'AA', 'type' => 'sum', 'labels' => ['default' => 'Total - Encaissé'], 'indicator' => 'amount', 'filter' => ['status' => 'collected']],
		'total_settled' => ['position' => 'AB', 'type' => 'sum', 'labels' => ['default' => 'Total - Réglé'], 'indicator' => 'amount', 'filter' => ['status' => 'settled']],
		'total_invoiced' => ['position' => 'AC', 'type' => 'sum', 'labels' => ['default' => 'Total - Facturé'], 'indicator' => 'amount', 'filter' => ['status' => 'invoiced']],
		'total_to_invoice' => ['position' => 'AD', 'type' => 'sum', 'labels' => ['default' => 'Total - A facturer'], 'indicator' => 'amount', 'filter' => ['status' => 'to_invoice']],
...
//					),
	...
	'student/property/school_period' => array(
			'type' => 'select',
			'modalities' => array(
					'Q1' => array('en_US' => 'Quarter 1', 'fr_FR' => '1ère période'),
					'Q2' => array('en_US' => 'Quarter 2', 'fr_FR' => '2ème période'),
					'Q3' => array('en_US' => 'Quarter 3', 'fr_FR' => '3ème période'),
			),
			'labels' => array(
					'en_US' => 'Period',
					'fr_FR' => 'Période',
...
//		'property_2' => 'F',
	...
	'event/absence/property/account_id' => array(
		...
		'type' => 'select',
		'account_type' => 'p-pit-studies',
		'account_status' => 'active,retention',
		'labels' => array(
			'en_US' => 'Student',
			'fr_FR' => 'Étudiant',
		),
