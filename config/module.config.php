...
/*		'tiny_2' => 'O',
	...
	'commitmentTerm/report/p-pit-studies' => array(
		...
		'invoice_account_collected' => ['position' => 'S', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Encaissé'], 'indicator' => 'amount', 'filter' => ['status' => 'collected', 'invoice_account_id' => true]],
		'invoice_account_settled' => ['position' => 'T', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Réglé'], 'indicator' => 'amount', 'filter' => ['status' => 'settled', 'invoice_account_id' => true]],
		'invoice_account_invoiced' => ['position' => 'U', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Facturé'], 'indicator' => 'amount', 'filter' => ['status' => 'invoiced', 'invoice_account_id' => true]],
		'invoice_account_to_invoice' => ['position' => 'V', 'type' => 'sum', 'labels' => ['default' => 'Financeur - A facturer'], 'indicator' => 'amount', 'filter' => ['status' => 'to_invoice', 'invoice_account_id' => true]],
		'invoice_account_expected' => ['position' => 'W', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Attendu'], 'indicator' => 'amount', 'filter' => ['status' => 'expected', 'invoice_account_id' => true]],
		'invoice_account_rejected' => ['position' => 'X', 'type' => 'sum', 'labels' => ['default' => 'Financeur - Rejeté'], 'indicator' => 'amount', 'filter' => ['status' => 'rejected', 'invoice_account_id' => true]],
		'total_collected' => ['position' => 'Y', 'type' => 'sum', 'labels' => ['default' => 'Total - Encaissé'], 'indicator' => 'amount', 'filter' => ['status' => 'collected']],
		'total_settled' => ['position' => 'Z', 'type' => 'sum', 'labels' => ['default' => 'Total - Réglé'], 'indicator' => 'amount', 'filter' => ['status' => 'settled']],
		'total_invoiced' => ['position' => 'AA', 'type' => 'sum', 'labels' => ['default' => 'Total - Facturé'], 'indicator' => 'amount', 'filter' => ['status' => 'invoiced']],
		'total_to_invoice' => ['position' => 'AB', 'type' => 'sum', 'labels' => ['default' => 'Total - A facturer'], 'indicator' => 'amount', 'filter' => ['status' => 'to_invoice']],
		'total_expected' => ['position' => 'AC', 'type' => 'sum', 'labels' => ['default' => 'Total - Attendu'], 'indicator' => 'amount', 'filter' => ['status' => 'expected']],
		'total_rejected' => ['position' => 'AD', 'type' => 'sum', 'labels' => ['default' => 'Total - Rejeté'], 'indicator' => 'amount', 'filter' => ['status' => 'rejected']],
	),
