...
//					),
	...
	'student/property/class' => array(
		'type' => 'select',
		'modalities' => array(
			'cm1' => array('default' => 'CM1'),
			'cm2' => array('default' => 'CM2'),
			'6e' => array('default' => 'Sixième'),
			'5e' => array('default' => 'Cinquième'),
			'4e' => array('default' => 'Quatrième'),
			'3e' => array('default' => 'Troisième'),
			'2nde' => array('default' => 'Seconde'),
			'2ndeProCommerce' => array('default' => 'Seconde pro commerce'),
			'2ndeProService' => array('default' => 'Seconde pro service'),
			'1ere' => array('default' => 'Première'),
			'1ereProCommerce' => array('default' => 'Première pro Commerce'),
			'1ereProGa' => array('default' => 'Première pro GA'),
			'1ereProService' => array('default' => 'Première pro Service'),
			'1ereProVente' => array('default' => 'Première pro Vente'),
			'term' => array('default' => 'Terminale'),
			'termES' => array('default' => 'Terminale ES'),
			'termL' => array('default' => 'Terminale L'),
			'termS' => array('default' => 'Terminale S'),
			'termSTMG' => array('default' => 'Terminale STMG'),
			'termProCommerce' => array('default' => 'Terminale pro commerce'),
			'termProVente' => array('default' => 'Terminale pro vente'),
			'cap-vente' => array('default' => 'CAP Vente'),
			'bts_com' => array('default' => 'BTS COM'),
			'bts_mco' => array('default' => 'BTS MCO'),
			'bts_ndrc' => array('default' => 'BTS NDRC'),
			'bts_muc' => array('default' => 'BTS MUC'),
			'bachelor_1' => array('default' => 'Bachelor 1'),
			'bachelor_2' => array('default' => 'Bachelor 2'),
			'bachelor_3' => array('default' => 'Bachelor 3'),
			'mastere_1' => array('default' => 'Mastère 1'),
			'mastere_2' => array('default' => 'Mastère 2'),
		),
		'labels' => array(
				'en_US' => 'Class',
				'fr_FR' => 'Classe',
